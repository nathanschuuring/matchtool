  ...
  return (
    <>
      ...
      <section className="py-10 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div
            className="rounded flex flex-col md:flex-row items-center gap-6 md:gap-10 p-6 md:p-8"
          ...
          >
            <div className="flex-shrink-0">
              <div
                style={{
                  ...
                  height: 180,
                  borderRadius: '50%',
                  background: 'linear-gradient(135deg, #0F3A7A, #0B2E62)',
                  display: 'flex',
                  alignItems: 'center',
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-800 mb-5">We helpen je graag verder.</p>
              <div className="flex flex-wrap gap-3">
                <button
                  className="px-6 py-2.5 font-bold text-sm rounded flex items-center gap-2 border bg-white"
